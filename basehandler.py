...
from google.appengine.ext import webapp, template
            ...
            if not user and facebook.access_token:
                ...
                try:
                    ...
                    user = User(key_name=facebook.user_id,
                        ...
                        email=me.get(u'email'), picture=me[u'picture'], last_hosted=(datetime.datetime.now() - datetime.timedelta(minutes=5)), display_type=2)
                    #user.put()
                    storeCache(user, user.user_id)
                except KeyError, ex:
